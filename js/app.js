...
function renderWishlist(){
  ...
  return `<div class="wishlist-wrap"><div class="wishlist-card"><div class="wishlist-head"><span>MY WISHLIST</span><div class="wishlist-actions"><button onclick="toggleWishlist()">Hide</button></div></div><div class="wishlist-body"><div class="wishlist-add"><div class="wishlist-search-wrap"><input id="wishlistInput" autocomplete="off" placeholder="Search available players" oninput="showWishlistSuggestions(this.value)" onfocus="showWishlistSuggestions(this.value)" onkeydown="wishlistKeydown(event)"><div id="wishlistSuggestions" class="wishlist-suggestions"></div></div><button class="primary" onclick="addWishlistFromSearch()">Add</button></div>${items}</div></div></div>`;
}
